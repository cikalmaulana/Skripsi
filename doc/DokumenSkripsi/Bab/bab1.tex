...
\label{sec:rumusan}
Rumusan masalah yang akan dibahas pada skripsi ini adalah bagaimana melakukan migrasi aplikasi Android WSDC 2017 ke {\it framework} Ionic versi 6?

\section{Tujuan}
\label{sec:tujuan}
Tujuan yang ingin dicapai dari penulisan skripsi ini adalah melakukan migrasi aplikasi Android WSDC 2017 ke {\it framework} Ionic versi 6.
