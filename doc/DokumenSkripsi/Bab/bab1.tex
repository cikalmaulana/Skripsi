...
\begin{enumerate}
    ...
    \item Walaupun Ionic Framework mendukung pengembangan aplikasi untuk sistem operasi iOS, aplikasi hanya akan diuji pada \textit{platform mobile} berbasis android. Sedangkan pengujian untuk perangkat berbasis iOS akan dilakukan oleh tim yang berbeda.
\end{enumerate}
