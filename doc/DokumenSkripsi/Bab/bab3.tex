...
\end{lstlisting} 
	\end{itemize}
		\item  Analisis Sistem Usulan pada Komponen \textit{Draw} \\
...
\end{lstlisting}
	...
	\end{itemize}
		\item  Analisis Sistem Usulan pada Komponen \textit{Home} \\
...
\end{lstlisting} 
	\end{itemize}
		...
		\item  Analisis Sistem Usulan pada Komponen \textit{Result} \\
