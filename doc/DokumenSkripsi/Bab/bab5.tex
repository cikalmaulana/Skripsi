...
7  & Pengguna menekan card Latest Announcements                                         & Aplikasi mengarhkan pengguna ke halaman Announcements                                & Sesuai                 \\ \hline
8  & Pengguna memilih menu Schedule pada Sidebar                                        & Aplikasi menampilkan halaman Schedule                                                & Sesuai                 \\ \hline
9  & Pengguna menekan tombol hari dan tanggal                                           & Aplikasi menampilkan jadwal yang ada pada hari dan tanggal yang dipilih              & Sesuai                 \\ \hline
10 & Pengguna melakukan swipe secara vertical baik dari kiri ke kanan maupun sebaliknya & Aplikasi menampilkan jadwal yang ada pada hari dan tanggal sebelum maupun sesudahnya & Sesuai                 \\ \hline
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Di halaman \textit{venues} dimana tulisan headline dari list map dijauhkan sedikit dari tulisan body karena terlalu dekat.
	\end{enumerate}
\end{enumerate}
